...
export default function UsuariosAdmin() {
    ...
    // URL de tu API
    const API_URL = "http://localhost:5000/api"; // Ajusta el puerto si es diferente
    ...
    const obtenerLideres = async () => {
        try {
            ...
            if (!response.ok) {
                throw new Error("No se pudo obtener la lista de líderes.");
            }
    ...
    const handleEliminar = async (id, nombre) => {
        const confirmar = window.confirm(
            `¿Estás seguro de eliminar al líder "${nombre}"?\n\nEsto borrará su cuenta en Clerk y en la base de datos.`
        );
        ...
        try {
            ...
            setLideres((prevLideres) => prevLideres.filter((lider) => lider.id !== id));
        } catch (err) {
            console.error(err);
            alert(`No se pudo eliminar al usuario: ${err.message}`);
        } finally {
        ...
        <div className="admin-layout">
            ...
            <div className="usuarios-container">
                ...
                <div className="usuarios-header">
                    ...
                    <p>Administra las cuentas de los Líderes, consulta sus grupos o elimínalos del sistema.</p>
                </div>
